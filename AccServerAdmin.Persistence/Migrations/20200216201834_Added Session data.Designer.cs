...
namespace AccServerAdmin.Persistence.Migrations
{
    ...
    [Migration("20200216201834_Added Session data")]
    partial class AddedSessiondata
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccServerAdmin.Domain.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AccServerAdmin.Domain.SessionDriver", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("SessionDriver");
                });

            modelBuilder.Entity("AccServerAdmin.Domain.SessionLap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AccServerAdmin.Domain.SessionLap", b =>
                {
                    b.HasOne("AccServerAdmin.Domain.SessionDriver", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId");

                    b.HasOne("AccServerAdmin.Domain.Session", null)
                        .WithMany("Laps")
