...
namespace AccServerAdmin.Service.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            var info = await _signInManager.GetExternalLoginInfoAsync(await _userManager.GetUserIdAsync(user)).ConfigureAwait(false);
            if (info == null)
            {
